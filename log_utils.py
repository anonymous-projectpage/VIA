...
def setup_wandb(
    ...
    # use an explicit directory instead of a tempdir (avoids losing logs)
    wandb_dir = os.path.join(os.getcwd(), "wandb_output")
    ...
    init_kwargs = dict(
        ...
        dir=wandb_dir,
        mode=mode,
        # keep settings minimal to avoid conflicts
